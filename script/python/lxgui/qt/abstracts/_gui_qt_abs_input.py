...
class AbsQtInputBaseDef(
    _gui_qt_abs_base.AbsQtValueBaseDef,
    _gui_qt_abs_base.AbsQtValueDefaultExtraDef,
    _gui_qt_abs_base.AbsQtValueValidationExtraDef,
    _gui_qt_abs_base.AbsQtValueHistoryExtraDef,
):
...
class AbsQtInputChooseExtraDef(
    _gui_qt_abs_base.AbsQtChooseExtraDef
):
