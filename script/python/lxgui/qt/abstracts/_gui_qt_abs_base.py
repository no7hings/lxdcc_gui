...
class AbsQtItemFilterDef(object):
    ...
    def _generate_item_keyword_filter_match_args_(self, texts):
    ...
    def _generate_item_tag_filter_tgt_match_args_(self, data_src):
    ...
    def _refresh_view_items_visible_by_any_filter_(self):
        ...
        for i_item in items:
            ...
            if tag_filter_data_src:
                i_is_enable, i_is_hidden = i_item._generate_item_tag_filter_tgt_match_args_(tag_filter_data_src)
            ...
            if keyword_filter_data_src:
                i_is_enable, i_is_hidden = i_item._generate_item_keyword_filter_match_args_(keyword_filter_data_src)
                if i_is_enable is True:
