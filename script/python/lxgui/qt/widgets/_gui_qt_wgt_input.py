...
class QtInputAsConstant(
    _gui_qt_wgt_entry.QtEntryFrame,
...
class QtInputAsConstantWithChoose(
    ...
    QT_POPUP_CHOOSE_CLS = _gui_qt_wgt_popup.QtPopupAsChoose
    ...
    def _build_input_entry_(self, value_type):
        ...
        #
        self._input_button = _gui_qt_wgt_button.QtIconPressButton()
...
class QtInputAsCapsule(
    ...
    QT_ENTRY_CLS = _gui_qt_wgt_entry.QtEntryAsCapsule
...
class QtInputAsBubbleWithChoose(
    ...
    QT_ENTRY_CLS = _gui_qt_wgt_entry.QtEntryAsBubble
...
class QtInputAsContent(
    ...
    QT_ENTRY_CLS = _gui_qt_wgt_entry.QtEntryAsContent
...
class QtInputAsList(
    ...
    QT_ENTRY_CLS = _gui_qt_wgt_entry.QtEntryAsList
    #
    QT_POPUP_CHOOSE_CLS = _gui_qt_wgt_popup.QtPopupAsChoose
    #
...
class QtInputAsPath(
    ...
    QT_ENTRY_EXTEND_CLS = _gui_qt_wgt_entry_extend.QtEntryExtendAsPath
...
class QtInputAsRgba(
    ...
    QT_POPUP_CHOOSE_CLS = _gui_qt_wgt_popup.QtPopupAsChooseForRgba
...
class QtInputAsIcon(
    ...
    QT_POPUP_CHOOSE_CLS = _gui_qt_wgt_popup.QtPopupAsChooseForIcon
    ...
    def _build_input_entry_(self, value_size, value_type):
        ...
        if value_size:
            for i in range(value_size):
                i_widget = _gui_qt_wgt_entry.QtEntryAsConstant()
