...
from lxgui.qt.widgets import _gui_qt_wgt_utility, _gui_qt_wgt_button, _gui_qt_wgt_resize, _gui_qt_wgt_entry_base, \
    _gui_qt_wgt_popup
...
class QtFilterBar(
    ...
    def _build_value_entry_(self, value_type):
        ...
        self._value_history_button._set_icon_file_path_(gui_core.GuiIcon.get('history'))
