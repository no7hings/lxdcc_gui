...
class QtInputAsFilter(
    ...
    QT_ENTRY_CLS = _gui_qt_wgt_entry.QtEntryAsConstant

    QT_COMPLETION_POPUP_CLS = _gui_qt_wgt_popup.QtPopupAsCompletion

    QT_HISTORY_POPUP_CLS = _gui_qt_wgt_popup.QtPopupAsHistory
    ...
    def __init__(self, *args, **kwargs):
        ...
        #
        self._entry_frame_widget = _gui_qt_wgt_entry.QtEntryFrame()
    ...
    def _build_input_entry_(self, value_type):
        ...
        #
        self.__text_bubbles = _gui_qt_wgt_bubble.QtTextBubbles()
        ...
        #
        self._history_button = _gui_qt_wgt_button.QtIconPressButton()
