...
class QtEntryAsGuide(
    ...
    #
    QT_POPUP_GUIDE_CHOOSE_CLS = _gui_qt_wgt_popup.QtPopupAsChooseForGuide
    #
    ...
    def eventFilter(self, *args):
        ...
        if widget == self:
            ...
            #
                ...
                if isinstance(entry_frame, _gui_qt_wgt_entry.QtEntryFrame):
...
class QtInputAsGuide(
    ...
    def _build_input_entry_(self, value_type):
        ...
        self._guide_tree_button = _gui_qt_wgt_button.QtIconPressButton()
