...
class QtGuideEntry(
    ...
    #
    QT_POPUP_GUIDE_CHOOSE_CLS = _gui_qt_wgt_popup.QtPopupAsGuideChoose
    #
...
class QtGuideBar(
    ...
    QT_POPUP_PROXY_CLS = _gui_qt_wgt_popup.QtPopupProxy
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._value_entry.setFont(QtFonts.Medium)
        #
