...
from lxgui.qt.widgets import _gui_qt_wgt_utility, _gui_qt_wgt_button, \
    _gui_qt_wgt_entry_base, _gui_qt_wgt_item, _gui_qt_wgt_entry
...
# entry
class AbsPrxTypeQtEntry(gui_prx_abstracts.AbsPrxWidget):
    QT_ENTRY_CLS = None
    ...
    def _set_file_show_(self):
        bsc_core.StgFileOpt(self.get()).open_in_system()
...
class _PrxStgObjsEntry(AbsPrxTypeQtEntry):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._open_button = _gui_prx_wdt_utility.PrxIconPressButton()
...
class PrxMediasOpenEntry(PrxEntryAsFilesOpen):
    def __init__(self, *args, **kwargs):
        ...
        self._create_button = _gui_prx_wdt_utility.PrxIconPressButton()
    ...
    def __do_screenshot_save(self, g):
        ...
        _gui_prx_wdt_utility.PrxScreenshotFrame.save_to(
            g, f
        )
        self.append(f)
        self.update_history()
    ...
    def __dot_screenshot_create(self):
        ...
        w = _gui_prx_wdt_utility.PrxScreenshotFrame()
...
class _PrxEntryForValueArray(AbsPrxTypeQtEntry):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._add_button = _gui_prx_wdt_utility.PrxIconPressButton()
...
class PrxEntryAsBoolean(AbsPrxTypeQtEntry):
    QT_WIDGET_CLS = _gui_qt_wgt_utility._QtTranslucentWidget
    QT_ENTRY_CLS = _gui_qt_wgt_button.QtCheckButton
...
class PrxEntryAsPressButton(AbsPrxTypeQtEntry):
    QT_WIDGET_CLS = _gui_qt_wgt_utility._QtTranslucentWidget
    QT_ENTRY_CLS = _gui_qt_wgt_button.QtPressButton
...
class PrxEntryAsSubProcessButton(AbsPrxTypeQtEntry):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._stop_button = _gui_prx_wdt_utility.PrxIconPressButton()
...
# proxy
class _AbsPrxTypeEntry(gui_prx_abstracts.AbsPrxWidget):
    PRX_ENTRY_CLS = None
...
class PrxEntryAsResolverEntity(_AbsPrxTypeEntry):
    QT_WIDGET_CLS = _gui_qt_wgt_utility._QtTranslucentWidget
    PRX_ENTRY_CLS = _gui_prx_wgt_view_for_tree.PrxTreeView
    NAMESPACE = 'resolver'
...
class PrxEntryAsFiles(_AbsPrxTypeEntry):
            ...
            if self._paths:
                ...
                for i_path in self._paths:
                    if bsc_core.StgPathOpt(i_path).get_is_file():
                        i_obj = bsc_core.StgFileOpt(i_path)
                        i_scheme = 'file'
                    else:
                        i_obj = bsc_core.StgDirectoryOpt(i_path)
                        i_scheme = 'folder'
                    #
                    obj_cur = i_obj
                    #
    ...
    def set_root(self, path):
        ...
        self._root_obj = bsc_core.StgDirectoryOpt(self._root_location)
