...
class KitDesktopHook(object):
    ...
    @classmethod
    def find_all_keys_at(cls, page_name):
        return rsc_core.RscDesktopTool.find_all_keys_at(page_name)

    @classmethod
    def find_all_group_keys_at(cls, page_name):
        return rsc_core.RscDesktopTool.find_all_group_keys_at(page_name)
