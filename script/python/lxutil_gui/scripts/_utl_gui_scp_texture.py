    ...
    def execute_by_data(self, button, cmds):
        ...
        def run_fnc_():
            ...
            for _i_index, _i_cmd in enumerate(self._cmds):
                ...
                #
                _i_t = bsc_core.SPCmdThread.set_start(_i_cmd, _i_index)
        ...
        if cmds:
            ...
            button.set_status(bsc_core.SPCmdThread.Status.Started)
            button.set_initialization(c, bsc_core.SPCmdThread.Status.Started)
