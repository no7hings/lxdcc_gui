# coding:utf-8
from lxutil_gui.qt.widgets import _gui_qt_wgt_utility, _gui_qt_wgt_button, _gui_qt_wgt_item
...
# port
#   info
class PrxPortInfo(utl_gui_prx_abstract.AbsPrxWidget):
...
#   status
class PrxPortStatus(utl_gui_prx_abstract.AbsPrxWidget):
    QT_WIDGET_CLS = _gui_qt_wgt_item._QtStatusItem
...
class PrxPortLabel(utl_gui_prx_abstract.AbsPrxWidget):
    QT_WIDGET_CLS = _gui_qt_wgt_utility.QtTextItem
