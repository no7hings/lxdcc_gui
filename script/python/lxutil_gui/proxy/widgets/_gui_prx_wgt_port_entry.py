...
from lxutil_gui.qt.widgets import _gui_qt_wgt_utility, _gui_qt_wgt_entry_base, _gui_qt_wgt_item, _gui_qt_wgt_entry

from lxutil_gui.proxy import utl_gui_prx_abstract

from lxutil_gui.proxy.widgets import _utl_gui_prx_wdt_utility, _gui_prx_wgt_port_base, _utl_gui_prx_wgt_view_for_tree
...
class AbsPrxTypeQtEntry(utl_gui_prx_abstract.AbsPrxWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.widget.setFixedHeight(_gui_prx_wgt_port_base.AttrConfig.PRX_PORT_HEIGHT)

    def _gui_build_(self):
        self._qt_layout = _gui_qt_wgt_utility.QtHBoxLayout(self._qt_widget)
...
class _PrxStgObjEntry(AbsPrxTypeQtEntry):
    ...
    QT_ENTRY_CLS = _gui_qt_wgt_entry.QtValueEntryAsConstantChoose
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._qt_entry_widget._set_value_choose_button_icon_file_path_(
            gui_core.RscIconFile.get('history')
        )
        ...
        self._qt_entry_widget._set_choose_button_state_icon_file_path_(
            gui_core.RscIconFile.get('state/popup')
        )
        #
...
#   file open
class PrxEntryFileOpen(_PrxStgObjEntry):
    def __init__(self, *args, **kwargs):
        super(PrxEntryFileOpen, self).__init__(*args, **kwargs)
        self._qt_open_or_save_button._set_name_text_('open file')
        self._qt_open_or_save_button._set_icon_name_('file/file')
        self._qt_open_or_save_button._set_tool_tip_(
            [
        ...
        self._qt_entry_widget._set_choose_popup_item_icon_file_path_(
            gui_core.RscIconFile.get('file/file')
        )
...
#   file save
class PrxEntryFileSave(_PrxStgObjEntry):
    def __init__(self, *args, **kwargs):
        super(PrxEntryFileSave, self).__init__(*args, **kwargs)
...
#   directory open
class PrxEntryAsDirectoryOpen(_PrxStgObjEntry):
    def __init__(self, *args, **kwargs):
        super(PrxEntryAsDirectoryOpen, self).__init__(*args, **kwargs)
        ...
        self._qt_entry_widget._set_choose_popup_item_icon_file_path_(
            gui_core.RscIconFile.get('file/folder')
        )
...
#   directory open
class PrxEntryAsDirectorySave(_PrxStgObjEntry):
    def __init__(self, *args, **kwargs):
        super(PrxEntryAsDirectorySave, self).__init__(*args, **kwargs)
...
class _PrxStgObjsEntry(AbsPrxTypeQtEntry):
    QT_WIDGET_CLS = _gui_qt_wgt_utility._QtTranslucentWidget
    QT_ENTRY_CLS = _gui_qt_wgt_entry.QtValueEntryAsList
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._qt_entry_widget._get_popup_choose_widget_()._set_popup_auto_resize_enable_(True)
        self._qt_entry_widget._set_value_choose_button_icon_file_path_(
            gui_core.RscIconFile.get('history')
        )
        self._qt_entry_widget._set_choose_button_state_icon_file_path_(
        ...
        self.widget.setFixedHeight(_gui_prx_wgt_port_base.AttrConfig.PRX_PORT_HEIGHT_2)

        self._ext_filter = 'All File (*.*)'

        self._ext_includes = []

        self._open_button = _utl_gui_prx_wdt_utility.PrxIconPressButton()
        self._qt_entry_widget._add_value_entry_button_(self._open_button.widget)
...
class PrxMediasOpenEntry(PrxEntryAsFilesOpen):
    def __init__(self, *args, **kwargs):
        ...
        self._create_button = _utl_gui_prx_wdt_utility.PrxIconPressButton()
        self._qt_entry_widget._add_value_entry_button_(self._create_button.widget)
    ...
    def __do_screenshot_save(self, g):
        ...
        _utl_gui_prx_wdt_utility.PrxScreenshotFrame.save_to(
            g, f
        )
        self.append(f)
        self.update_history()
...
class _PrxEntryForValueArray(AbsPrxTypeQtEntry):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._qt_entry_widget._set_size_policy_height_fixed_mode_()
        self._qt_entry_widget._set_value_choose_button_icon_file_path_(
            gui_core.RscIconFile.get('attribute')
        )

        self.widget.setFixedHeight(_gui_prx_wgt_port_base.AttrConfig.PRX_PORT_HEIGHT_2)

        self._add_button = _utl_gui_prx_wdt_utility.PrxIconPressButton()
        self._qt_entry_widget._add_value_entry_button_(self._add_button.widget)
...
class _PrxEntryAsArrayWithChoose(AbsPrxTypeQtEntry):
    QT_WIDGET_CLS = _gui_qt_wgt_utility._QtTranslucentWidget
    QT_ENTRY_CLS = _gui_qt_wgt_entry.QtValueEntryAsListWithChoose
    ...
    def set_choose_values(self, *args, **kwargs):
        ...
        self._qt_entry_widget._clear_choose_popup_()
...
# shotgun
class _AbsEntryAsShotgunDef(object):
    @classmethod
...
#   entity
class PrxEntryAsShotgunEntityByChoose(
    AbsPrxTypeQtEntry,
    _AbsEntryAsShotgunDef
):
    QT_WIDGET_CLS = _gui_qt_wgt_utility._QtTranslucentWidget
    QT_ENTRY_CLS = _gui_qt_wgt_entry.QtValueEntryAsConstantChoose

    def __init__(self, *args, **kwargs):
        super(PrxEntryAsShotgunEntityByChoose, self).__init__(*args, **kwargs)
        self._shotgun_entity_kwargs = {}
        # entry
        self._qt_entry_widget._set_value_entry_enable_(True)
        # choose
        self._qt_entry_widget._set_popup_choose_auto_resize_enable_(False)
        self._qt_entry_widget._set_choose_index_show_enable_(True)
        self._qt_entry_widget._set_popup_choose_tag_filter_enable_(True)
        self._qt_entry_widget._set_popup_choose_keyword_filter_enable_(True)
        self._qt_entry_widget._set_popup_choose_item_size_(40, 40)
        self._qt_entry_widget._set_value_choose_button_icon_file_path_(
            gui_core.RscIconFile.get('application/shotgrid')
        )
        self._qt_entry_widget._set_choose_button_state_icon_file_path_(
            gui_core.RscIconFile.get('state/popup')
        )
    ...
    def set_shotgun_entity_kwargs(
        ...
        def build_fnc_(args):
            ...
            self._qt_entry_widget._set_choose_popup_image_url_dict_(image_url_dict)
            self._qt_entry_widget._set_choose_popup_keyword_filter_dict_(keyword_filter_dict)
            self._qt_entry_widget._set_choose_popup_tag_filter_dict_(tag_filter_dict)
...
#   entities
class PrxEntryAsShotgunEntitiesWithChoose(
    AbsPrxTypeQtEntry,
    _AbsEntryAsShotgunDef
):
    QT_WIDGET_CLS = _gui_qt_wgt_utility._QtTranslucentWidget
    ...
    def __init__(self, *args, **kwargs):
        super(PrxEntryAsShotgunEntitiesWithChoose, self).__init__(*args, **kwargs)
        self._shotgun_entity_kwargs = {}
        # entry
...
class PrxEntryAsConstantChoose(AbsPrxTypeQtEntry):
    QT_WIDGET_CLS = _gui_qt_wgt_utility._QtTranslucentWidget
    QT_ENTRY_CLS = _gui_qt_wgt_entry.QtValueEntryAsConstantChoose

    def __init__(self, *args, **kwargs):
        super(PrxEntryAsConstantChoose, self).__init__(*args, **kwargs)
    ...
    def set(self, *args, **kwargs):
        ...
        if isinstance(_, (tuple, list)):
            self._qt_entry_widget._set_choose_values_(_)
            if _:
                self.set(_[-1])
            ...
            self._qt_entry_widget._set_choose_value_by_index_(int(_))

    def set_option(self, *args, **kwargs):
        self._qt_entry_widget._set_choose_values_(args[0])

    def set_icon_file_as_value(self, value, file_path):
        self._qt_entry_widget._set_choose_popup_item_icon_file_path_at_(
            value, file_path
        )
    ...
    def set_default(self, *args, **kwargs):
        ...
        if isinstance(_, six.string_types):
            self._qt_entry_widget._set_value_default_(_)
        elif isinstance(_, (int, float)):
            self._qt_entry_widget._set_choose_value_default_by_index_(_)
...
# icon choose
class PrxEntryAsIconChoose(AbsPrxTypeQtEntry):
    QT_WIDGET_CLS = _gui_qt_wgt_utility._QtTranslucentWidget
    QT_ENTRY_CLS = _gui_qt_wgt_entry.QtValueEntryAsIconChoose

    def __init__(self, *args, **kwargs):
        super(PrxEntryAsIconChoose, self).__init__(*args, **kwargs)
        self.widget.setFocusProxy(self._qt_entry_widget)
...
class _PrxEntryAsConstant(AbsPrxTypeQtEntry):
    QT_WIDGET_CLS = _gui_qt_wgt_utility._QtTranslucentWidget
    QT_ENTRY_CLS = _gui_qt_wgt_entry.QtValueEntryAsConstant
...
#   text
class PrxEntryAsText(_PrxEntryAsConstant):
    def __init__(self, *args, **kwargs):
        super(PrxEntryAsText, self).__init__(*args, **kwargs)
        self.set_value_type(str)


#   script
class PrxEntryAsScript(AbsPrxTypeQtEntry):
    QT_WIDGET_CLS = _gui_qt_wgt_utility._QtTranslucentWidget
    QT_ENTRY_CLS = _gui_qt_wgt_entry.QtValueEntryAsContentEdit

    def __init__(self, *args, **kwargs):
        super(PrxEntryAsScript, self).__init__(*args, **kwargs)
        self.widget.setFixedHeight(_gui_prx_wgt_port_base.AttrConfig.PRX_PORT_HEIGHT_2)
        #
        self._qt_entry_widget._get_resize_handle_()._set_resize_target_(self.widget)
        self._qt_entry_widget._set_resize_enable_(True)
...
#   string
class PrxEntryAsString(_PrxEntryAsConstant):
    def __init__(self, *args, **kwargs):
        super(PrxEntryAsString, self).__init__(*args, **kwargs)
        self.set_value_type(str)


#   integer
class PrxEntryAsInteger(_PrxEntryAsConstant):
    def __init__(self, *args, **kwargs):
        super(PrxEntryAsInteger, self).__init__(*args, **kwargs)
        self.set_value_type(int)


#   boolean as check box
class PrxEntryAsBoolean(AbsPrxTypeQtEntry):
    QT_WIDGET_CLS = _gui_qt_wgt_utility._QtTranslucentWidget
    QT_ENTRY_CLS = _gui_qt_wgt_item.QtCheckItem

    def __init__(self, *args, **kwargs):
        super(PrxEntryAsBoolean, self).__init__(*args, **kwargs)
...
#   float
class PrxEntryAsFloat(_PrxEntryAsConstant):
    def __init__(self, *args, **kwargs):
        super(PrxEntryAsFloat, self).__init__(*args, **kwargs)
        self.set_value_type(float)


#   press button
class PrxEntryAsPressButton(AbsPrxTypeQtEntry):
    QT_WIDGET_CLS = _gui_qt_wgt_utility._QtTranslucentWidget
    QT_ENTRY_CLS = _gui_qt_wgt_item.QtPressButton

    def __init__(self, *args, **kwargs):
        super(PrxEntryAsPressButton, self).__init__(*args, **kwargs)
...
#   sub process button
class PrxEntryAsSubProcessButton(AbsPrxTypeQtEntry):
    QT_WIDGET_CLS = _gui_qt_wgt_utility._QtTranslucentWidget
    QT_ENTRY_CLS = _gui_qt_wgt_item.QtPressButton

    def __init__(self, *args, **kwargs):
        super(PrxEntryAsSubProcessButton, self).__init__(*args, **kwargs)
        self._stop_button = _utl_gui_prx_wdt_utility.PrxIconPressButton()
...
#   validation button
class PrxEntryValidationButton(AbsPrxTypeQtEntry):
    QT_WIDGET_CLS = _gui_qt_wgt_utility._QtTranslucentWidget
    QT_ENTRY_CLS = _gui_qt_wgt_item.QtPressButton

    def __init__(self, *args, **kwargs):
        super(PrxEntryValidationButton, self).__init__(*args, **kwargs)
...
#   capsule
class PrxEntryAsCapsule(AbsPrxTypeQtEntry):
    QT_WIDGET_CLS = _gui_qt_wgt_utility._QtTranslucentWidget
    QT_ENTRY_CLS = _gui_qt_wgt_entry_base.QtEntryAsCapsule

    def __init__(self, *args, **kwargs):
        super(PrxEntryAsCapsule, self).__init__(*args, **kwargs)
...
# any2, any3
class _PrxEntryAsAnyTuple(AbsPrxTypeQtEntry):
    QT_WIDGET_CLS = _gui_qt_wgt_utility._QtTranslucentWidget
    QT_ENTRY_CLS = _gui_qt_wgt_entry.QtValueEntryAsTuple

    def __init__(self, *args, **kwargs):
        super(_PrxEntryAsAnyTuple, self).__init__(*args, **kwargs)
...
#   integer2, 3, ...
class PrxEntryAsIntegerTuple(_PrxEntryAsAnyTuple):
    def __init__(self, *args, **kwargs):
        super(PrxEntryAsIntegerTuple, self).__init__(*args, **kwargs)
        self._qt_entry_widget._build_value_entry_(2, int)


#   float2, 3, ...
class PrxEntryAsFloatTuple(_PrxEntryAsAnyTuple):
    def __init__(self, *args, **kwargs):
        super(PrxEntryAsFloatTuple, self).__init__(*args, **kwargs)
        self._qt_entry_widget._build_value_entry_(2, float)


#   rgba
class PrxEntryAsRgbaChoose(_PrxEntryAsConstant):
    QT_ENTRY_CLS = _gui_qt_wgt_entry.QtValueEntryAsRgbaByChoose

    def __init__(self, *args, **kwargs):
        super(PrxEntryAsRgbaChoose, self).__init__(*args, **kwargs)
...
# resolver
#   entity
class PrxEntryAsResolverEntity(_AbsPrxTypeEntry):
    QT_WIDGET_CLS = _gui_qt_wgt_utility._QtTranslucentWidget
    PRX_ENTRY_CLS = _utl_gui_prx_wgt_view_for_tree.PrxTreeView
    NAMESPACE = 'resolver'

    def __init__(self, *args, **kwargs):
        super(PrxEntryAsResolverEntity, self).__init__(*args, **kwargs)
...
# array
#   nodes
class PrxEntryAsNodes(_AbsPrxTypeEntry):
    QT_WIDGET_CLS = _gui_qt_wgt_utility._QtTranslucentWidget
    PRX_ENTRY_CLS = _utl_gui_prx_wgt_view_for_tree.PrxTreeView
    NAMESPACE = 'dcc'

    def __init__(self, *args, **kwargs):
        super(PrxEntryAsNodes, self).__init__(*args, **kwargs)
...
#   files
class PrxEntryAsFiles(_AbsPrxTypeEntry):
    QT_WIDGET_CLS = _gui_qt_wgt_utility._QtTranslucentWidget
    PRX_ENTRY_CLS = _utl_gui_prx_wgt_view_for_tree.PrxTreeView
    NAMESPACE = 'storage'

    def __init__(self, *args, **kwargs):
        super(PrxEntryAsFiles, self).__init__(*args, **kwargs)
