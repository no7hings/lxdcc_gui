...
class AbsTaskMethodObjGuiDef(object):
    ...
    def _set_method_group_obj_gui_add_(cls, obj, obj_gui_parent=None, tree_viewer=None):
        ...
        obj_gui.set_name_icon(obj.name)
        obj_gui.set_name_icon(obj.type_name, 1)
        return obj_gui
    @classmethod
...
class AbsSceneMethodRunnerPanel(
    ...
    def _set_panel_build_(self):
        ...
        self._check_button.set_name_icon('Check')
        ...
        self._repair_button.set_name_icon('Repair')
        ...
        self._export_button.set_name_icon('Export')
