...
class AbsPnlRsvUnitLoader(prx_widgets.PrxSessionWindow):
    ...
    def __setup_gui_viewers_(self, scroll_area):
        ...
        #
        self._gui_rsv_obj_opt = gui_prx_scripts.GuiPrxScpForResolver(
            self._resolver,
    ...
    def __gui_add_unit_(self, rsv_task):
        ...
        if task_prx_item is not None:
            ...
            if visible is True:
                ...
                task_prx_item.set_status(task_prx_item.ValidationStatus.Normal)
            else:
                task_prx_item.set_status(task_prx_item.ValidationStatus.Disable)
