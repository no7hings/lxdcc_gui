...
from lxutil_gui.qt.widgets import _gui_qt_wgt_utility, _gui_qt_wgt_entry_base
...
class QtTreeWidget(
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.setStyleSheet(gui_core.QtStyleMtd.get('QTreeView'))
        # header view
        ...
        self.header().setStyleSheet(
            gui_core.QtStyleMtd.get('QHeaderView')
        )
