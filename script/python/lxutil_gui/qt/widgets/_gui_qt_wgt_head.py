...
class AbsQtHead(
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._expand_icon_file_path_0 = gui_core.RscIconFile.get('expandopen')
        self._expand_icon_file_path_1 = gui_core.RscIconFile.get('expandclose')
    ...
    def _set_expand_icon_names_(self, icon_name_0, icon_name_1):
        self._expand_icon_file_path_0 = gui_core.RscIconFile.get(icon_name_0)
        self._expand_icon_file_path_1 = gui_core.RscIconFile.get(icon_name_1)
        self._refresh_expand_()

    def _set_expand_sub_icon_names_(self, icon_name_0, icon_name_1):
        self._expand_sub_icon_file_path_0 = gui_core.RscIconFile.get(icon_name_0)
        self._expand_sub_icon_file_path_1 = gui_core.RscIconFile.get(icon_name_1)
        self._refresh_expand_()
...
class AbsQtExpandHead1(
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._is_expanded = False
        self._expand_icon_file_path_0 = gui_core.RscIconFile.get('qt-style/arrow-down')
        self._expand_icon_file_path_1 = gui_core.RscIconFile.get('qt-style/arrow-right')
        self._expand_icon_file_path_2 = gui_core.RscIconFile.get('qt-style/arrow-up')
        #
        r, g, b = 135, 135, 135
        h, s, v = bsc_core.RawColorMtd.rgb_to_hsv(r, g, b)
        color = bsc_core.RawColorMtd.hsv2rgb(h, s*.75, v*.75)
...
class QtVExpandHead1(AbsQtExpandHead1):
    def __init__(self, *args, **kwargs):
        ...
        self._expand_icon_file_path_0 = gui_core.RscIconFile.get('qt-style/arrow-right')
        self._expand_icon_file_path_1 = gui_core.RscIconFile.get('qt-style/arrow-down')
        self._expand_icon_file_path_2 = gui_core.RscIconFile.get('qt-style/arrow-left')
...
class AbsQtExpandHead2(
    ...
    def __init__(self, *args, **kwargs):
        ...
        #
        self._is_expanded = False
        self._expand_icon_file_path_0 = gui_core.RscIconFile.get('v-bar-open')
        self._expand_icon_file_path_1 = gui_core.RscIconFile.get('v-bar-close')
...
class QtVExpandHead2(AbsQtExpandHead2):
    def __init__(self, *args, **kwargs):
        ...
        self._icon_draw_percent = .75
        self._expand_icon_file_path_0 = gui_core.RscIconFile.get('h-bar-open')
        self._expand_icon_file_path_1 = gui_core.RscIconFile.get('h-bar-close')