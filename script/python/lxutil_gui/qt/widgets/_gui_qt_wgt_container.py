...
from lxutil_gui.qt.widgets import _gui_qt_wgt_utility, _gui_qt_wgt_head, _gui_qt_wgt_drag
...
class QtHToolBox(AbsQtToolBox):
    QT_HEAD_CLS = _gui_qt_wgt_head.QtHExpandHead2
...
class QtVToolBox(AbsQtToolBox):
    QT_HEAD_CLS = _gui_qt_wgt_head.QtVExpandHead2
