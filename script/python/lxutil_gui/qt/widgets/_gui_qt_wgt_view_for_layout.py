...
class QtToolGridLayoutWidget(
    ...
    def _refresh_widget_draw_geometry_(self):
        ...
        if self._get_action_flag_is_match_(
            ...
            index_maximum = self._layout_item_stack.get_index_maximum()
    ...
    def _init_layout_base_def_(self, widget):
        ...
        self._layout_item_stack = gui_qt_models.GuiLayoutItemStack(self)
...
class QtToolGroupVLayoutWidget(
    ...
    def _refresh_widget_draw_geometry_(self):
        ...
        if self._get_action_flag_is_match_(
            ...
            c_v_y = v_y
            for i_widget in self._layout_item_stack.get_widgets():
                i_widget.show()
        ...
        if widget == self:
            if event.type() == QtCore.QEvent.Resize:
                ...
                if self._get_action_flag_is_match_(
                    ...
                    self._do_drop_child_polish_(event)
        elif widget in self._layout_item_stack.get_widgets():
