...
from lxutil_gui.qt.widgets import _gui_qt_wgt_utility, _gui_qt_wgt_button, _gui_qt_wgt_chart
...
class QtPressButton(
    ...
    def _set_sub_process_initialization_(self, count, status):
        super(QtPressButton, self)._set_sub_process_initialization_(count, status)
        if count > 0:
            self._set_status_(
                self.Status.Started
            )
    ...
    def _set_sub_process_restore_(self):
        super(QtPressButton, self)._set_sub_process_restore_()
...
class _QtHContractItem(
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._expand_icon_file_path_0 = gui_core.RscIconFile.get('contract_v_l')
        self._expand_icon_file_path_1 = gui_core.RscIconFile.get('contract_v_r')
    ...
    def _set_expand_direction_(self, direction):
        if direction == self.CollapseDirection.RightToLeft:
            ...
            self._expand_icon_file_path_0 = gui_core.RscIconFile.get('contract_v_r')
            self._expand_icon_file_path_1 = gui_core.RscIconFile.get('contract_v_l')
        #
        self._refresh_expand_()
...
class _QtWindowHead(
    ...
    def __init__(self, *args, **kwargs):
        ...
        #
        self._close_button = _gui_qt_wgt_button.QtIconPressButton(self)
        self._close_button._set_icon_file_path_(
            gui_core.RscIconFile.get('close')
        )
        self._close_button._set_hover_icon_file_path_(
            gui_core.RscIconFile.get('close-hover')
        )
        #
