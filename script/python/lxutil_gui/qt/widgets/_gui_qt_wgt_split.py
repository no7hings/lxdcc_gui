...
class _AbsQtSplitterHandle(
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._contract_l_draw_icon_file_path = gui_core.RscIconFile.get(self._contract_icon_name_l)
        self._contract_r_rect = QtCore.QRect()
        self._contract_r_draw_rect = QtCore.QRect()
        self._contract_r_draw_icon_file_path = gui_core.RscIconFile.get(self._contract_icon_name_r)
        self._swap_rect = QtCore.QRect()
        self._swap_draw_rect = QtCore.QRect()
        self._swap_icon_file_path = gui_core.RscIconFile.get(self._swap_icon_name)
        #
        ...
        if self._get_orientation_() == QtCore.Qt.Horizontal:
            self._resize_icon_file_path = gui_core.RscIconFile.get('resize-handle-v')
        elif self._get_orientation_() == QtCore.Qt.Vertical:
            self._resize_icon_file_path = gui_core.RscIconFile.get('resize-handle-h')
...
class QtHSplitter_(QtWidgets.QSplitter):
    def __init__(self, *args, **kwargs):
        ...
        self.setStyleSheet(
            gui_core.QtStyleMtd.get('QSplitter')
        )
