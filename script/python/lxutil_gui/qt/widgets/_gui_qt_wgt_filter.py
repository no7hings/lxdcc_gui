...
from lxutil_gui.qt.widgets import _gui_qt_wgt_utility, _gui_qt_wgt_button, _gui_qt_wgt_resize, _gui_qt_wgt_entry_base, \
    _gui_qt_wgt_popup
...
class QtFilterBar(
    ...
    #
    QT_POPUP_HISTORY_CLS = _gui_qt_wgt_popup.QtPopupAsHistoryChoose
    QT_POPUP_COMPLETION_CLS = _gui_qt_wgt_popup.QtPopupAsCompletion

    def _do_popup_choose_start_(self):
        self._history_extra_widget._do_popup_start_()
    ...
    def __init__(self, *args, **kwargs):
        ...
        #
        self._result_label = _gui_qt_wgt_utility.QtTextItem()
        # todo: fix result show bug
        # self._result_label.hide()
        qt_layout_0.addWidget(self._result_label)
        #
        self._resize_handle = _gui_qt_wgt_resize.QtHResizeHandle()
        self._resize_handle._set_resize_icon_file_paths_(
            [
                gui_core.RscIconFile.get('resize-handle-v'), gui_core.RscIconFile.get('resize-handle-v')
            ]
        )
        ...
        #
        self._match_case_button = _gui_qt_wgt_button.QtIconPressButton()
        ...
        #
        self._match_word_button = _gui_qt_wgt_button.QtIconPressButton()
        ...
        # occurrence
        self._occurrence_previous_button = _gui_qt_wgt_button.QtIconPressButton()
        ...
        self._occurrence_previous_button._set_icon_file_path_(
            gui_core.RscIconFile.get('occurrence-previous-disable')
        )
        ...
        #
        self._occurrence_next_button = _gui_qt_wgt_button.QtIconPressButton()
        ...
        self._occurrence_next_button._set_icon_file_path_(
            gui_core.RscIconFile.get('occurrence-next-disable')
        )
    ...
    def _build_value_entry_(self, value_type):
        ...
        #
        self._header_button = _gui_qt_wgt_button.QtIconPressButton()
        ...
        #
        self._entry_clear_button = _gui_qt_wgt_button.QtIconPressButton()
        ...
        self._entry_clear_button.press_clicked.connect(self._execute_user_entry_clear_)
        #
        self._value_history_button = _gui_qt_wgt_button.QtIconPressButton()
        self._value_entry_layout.addWidget(self._value_history_button)
        self._value_history_button._set_icon_file_path_(gui_core.RscIconFile.get('history'))
    ...
    def __refresh_filter_(self):
        self._match_case_button._set_icon_file_path_(
            gui_core.RscIconFile.get(self._match_case_icon_names[self._is_match_case])
        )
        #
        self._match_word_button._set_icon_file_path_(
            gui_core.RscIconFile.get(self._match_word_icon_names[self._is_match_word])
        )
    ...
    def _set_occurrence_buttons_enable_(self, boolean):
        if boolean is True:
            self._occurrence_previous_button._set_icon_file_path_(
                gui_core.RscIconFile.get('occurrence-previous')
            )
            self._occurrence_next_button._set_icon_file_path_(
                gui_core.RscIconFile.get('occurrence-next')
            )
        else:
            self._occurrence_previous_button._set_icon_file_path_(
                gui_core.RscIconFile.get('occurrence-previous-disable')
